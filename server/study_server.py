...
DEFAULT_CONFIG = {
    ...
    "update_url": "https://raw.githubusercontent.com/ehawkin/study-hub-kit/main/version.json",
    "port": DEFAULT_PORT,
  ...
  shareBtn.addEventListener('click', function () {
    ...
    fetch('/api/share?module=' + encodeURIComponent(%(codejs)s),
      ...
      .then(function (r) {
        ...
        var rep = r.report || {};
        ssays.textContent = 'Ready: ' + (r.zip || '') + ', holding ' +
...
# 🔴 Item 10 of the 7PAYFMND retrospective, approved by EH 2026-08-23: say that a
# course may mix delivery formats within a single week, because one of his does.
# 7PAYFMND serves 9 lectures as Kaltura recordings and 29 as HTML slide packages,
